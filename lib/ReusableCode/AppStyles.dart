...
class AppStyles{
  ...
  //Colors
  static TextStyle Black1 = const TextStyle(color: Color(0xFF222831));
  static TextStyle Black2 = const TextStyle(color: Color(0xFF31363F));
  static TextStyle Teal = const TextStyle(color: Color(0xFF76ABAE));
  static TextStyle Gray = const TextStyle(color: Color(0xFFEEEEEE));
