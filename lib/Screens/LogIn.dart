  ...
  Future<void> signIn(BuildContext context) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => MainApp()), // Replace HomePage with your actual home page widget
      );
    } catch (e) {
      // Handle authentication errors here
      print('Error signing in: $e');
                            ...
                            child: Form(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  ...
                                  child: Text(
                                    'Log in',
                                    style: AppStyles.Black1.copyWith(fontSize: 15, fontWeight: FontWeight.w600),
                                  ),
                                ),
